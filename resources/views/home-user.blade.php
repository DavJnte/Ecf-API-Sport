...
<body class="container-fluid">
  <div class="container-fluid row justify-content-center no-margin pl-5 pr-5 mt-5 full-mt">
    <main class="col-md-12 login-form p-5">
      <h4 class="login-title gotham text-black-bold">Welcome {{session()->get('user')->name}} ! <span class="text-lemon"> <?php if ($users_parent) { ?>Franchise : <?php echo $users_parent[0]->name;
                                                                                                                                                                } ?></span></h4>
      ...
      <table class="table table-light">
        ...
        <tbody>
          <tr>
            ...
            <td>
              <?php if (session()->get('user')->verified == 0) {
                echo 'Non vérifié';
              } else {
                echo 'Vérifié';
              } ?>
